...
let g:colors_name='paramount-indie'
...
let s:darker_green    = { "gui": "#00d700", "cterm": "40"  }
...
call s:h("IncSearch",     {"bg": s:lightest_gray, "fg": s:darker_green})
call s:h("Search",        {"bg": s:lightest_gray, "fg": s:light_green})
...
call s:h("htmlH1",        {"bg": s:bg, "fg": s:green})
call s:h("htmlH2",        {"bg": s:bg, "fg": s:green})
call s:h("htmlH3",        {"bg": s:bg, "fg": s:green})
call s:h("htmlH4",        {"bg": s:bg, "fg": s:bg_subtle})
call s:h("htmlH5",        {"bg": s:bg, "fg": s:bg_subtle})
call s:h("htmlH6",        {"bg": s:bg, "fg": s:bg_subtle})
